...
?>
	...
	var chart = new google.visualization.LineChart(document.getElementById('chart_combined_week_test'));
      google.visualization.events.addListener(chart, 'ready', function () {
        chart_combined_week_test.innerHTML = '<img src="' + chart.getImageURI() + '">';
        console.log(chart_combined_week_test.innerHTML);
		document.getElementById('png').outerHTML = ' ' + chart.getImageURI() + ' ';
      });
	  chart.draw(data, {
		width: 350,
		height: 200,
...
<div class="wrapper">
	...
	<div class="section">
		...
		<div class="secright">
			<h2>Hits per week from inception:</h2>
			<div id="chart_combined_week_test"></div>
			<div id='png'></div>
		</div>
		<div class="clear"></div>
	</div>
